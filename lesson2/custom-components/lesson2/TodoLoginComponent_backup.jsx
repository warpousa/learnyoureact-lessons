...
class TodoLoginComponent extends React.Component {
  render() {
    return (
        <div>
            <div style={{backgroundColor: "#e1eff0", minHeight:"550px", display: "flex", margin: "30px auto 15px auto", maxWidth: "990px", padding: "17px", flexDirection: "column"}}>  
            <div style={{fontSize: "3em", fontWeight: "bold", color: "#405c8a", display: "flex", padding: "0.5em"}}>
            Please Log In
            </div>
